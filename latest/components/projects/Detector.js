    ...
    <div className={styles.projectContent}>
      <section>
        ...
        <p>{`
          ...
          (which behaved like a lever arm, with its height bending the platform more than it should have).
        ...
        <div className={styles.fileLink}>
          <a href="/pdfs/Detector-Rules-Manual-2023.pdf" target="_blank" rel="noopener noreferrer">
      ...
      <section>
        ...
        <Image
          ...
          alt="Hand-labeled photo of the Detector: a breadboard with the 24-bit ADC, transistor, resistors, LEDs, and 16x2 LCD wired to an Elegoo Uno R3, next to the strain gauge apparatus with its 3D printed cover on wooden blocks"
          width={1108}
          height={837}
      ...
      <section>
        <h2>{"Code"}</h2>
        <p>{`
          Here is my original code; during calibration, I measure the voltages corresponding to the masses (v0 is 0g, v20 is 20g, etc)
          and it creates a line between those points.
          This must be done during the calibration period for the most accurate measurements.
        `}</p>
        <div className={styles.fileLink}>
          <a href="/code/detector_zipped.zip" download>
