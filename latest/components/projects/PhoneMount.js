        ...
        <div className={styles.flexContainer}>
          ...
          <div className={styles.flexImage}>
            <Image
              ...
              alt="The finished mount: the cut top of a Gatorade bottle screwed onto a 3D printed base with Velcro straps, glued to a white phone tray with a lanyard attached"
              width={3783}
              height={2770}
              style={{
                width: '100%',
