      ...
      <div className={styles.projectContent}>
        ...
        <section>
          ...
          <ul>
            ...
            <li>LEDs: light up to represent different mass ranges </li>
        ...
        <section>
          ...
          <p>
            ...
            Next, it was added as a variable resistor in a wheatstone bridge, which consisted of two 220 ohm resistors and one 350 ohm resistor (soldered together) to keep it balanced. 
            The resulting signal was put into a network of resistors, capacitors, and one transistor before entering a 24-bit ADC, which was first soldered to a surface mount adapter board and pin headers before it could be assembled on the breadboard. 
